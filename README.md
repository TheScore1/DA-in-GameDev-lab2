...
- Выбранный мною ресурс - металлолом. Он один из самых основых ресурсов, нужный везде. Используется для крафтов, торговли и изучения новых рецептов на верстаках. Подробнее изображено ниже:
